              ...
              return `
                <div class="mini" style="margin-bottom:10px;">
                  <div style="display:grid; grid-template-columns:minmax(240px, 320px) minmax(0, 1fr); gap:18px; align-items:start;">
                    ...
                    <div style="display:grid; grid-template-columns:minmax(0,1fr) 280px; gap:12px; align-items:start; min-width:0;">
                      <form method="POST" action="/admin/users/${encodeURIComponent(u.id)}/role" style="display:flex; flex-direction:column; gap:12px; min-width:0;">
                        <div style="display:grid; grid-template-columns:repeat(2,minmax(150px,1fr)) auto; gap:12px; align-items:end;">
                          <div>
                        ...
                        <div data-organizer-permissions style="${normalizedUserRole === "organizer" ? "" : "display:none;"}">
                          ...
                          <div style="display:grid; grid-template-columns:repeat(4,minmax(0,1fr)); gap:8px 12px; padding:12px; border:1px solid var(--line); border-radius:var(--radius-inner); background:#fff;">
                            ${ORGANIZER_SECTION_KEYS.map((section) => `
                              <label style="display:flex; align-items:center; gap:10px; color:var(--text); font-weight:600; min-height:32px; line-height:1.2; padding:4px 8px; border-radius:10px;">
