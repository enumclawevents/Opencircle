            ...
            <form method="POST" action="/admin/events" enctype="multipart/form-data">
              ...
              <div class="rec-box">
                ...
                <div class="event-type-picker" id="eventTypePicker">
                  <button type="button" class="event-type-card ${inferredEventType === "single" ? "is-active" : ""}" data-event-type="single" onclick="(function(btn,type){var hidden=document.getElementById('eventTypeChoice');var shell=document.getElementById('eventTypeShell');var picker=document.getElementById('eventTypePicker');var rec=document.getElementById('recurrenceSettings');var multi=document.getElementById('multiDayScheduleShell');var hasRec=document.getElementById('hasRecurrence');var recType=document.getElementById('recurrenceType');if(hidden) hidden.value=type;if(shell) shell.classList.add('is-visible');if(rec) rec.style.display=type==='recurring'?'':'none';if(multi) multi.classList.toggle('is-visible', type==='multi-day');if(picker){Array.prototype.forEach.call(picker.querySelectorAll('[data-event-type]'), function(el){el.classList.toggle('is-active', el===btn);});}if(hasRec){hasRec.checked=type==='recurring';try{hasRec.dispatchEvent(new Event('change',{bubbles:true}));}catch(_){}}if(recType){try{recType.dispatchEvent(new Event('change',{bubbles:true}));}catch(_){}}})(this,'single')">
                  ...
                  <button type="button" class="event-type-card ${inferredEventType === "multi-day" ? "is-active" : ""}" data-event-type="multi-day" onclick="(function(btn,type){var hidden=document.getElementById('eventTypeChoice');var shell=document.getElementById('eventTypeShell');var picker=document.getElementById('eventTypePicker');var rec=document.getElementById('recurrenceSettings');var multi=document.getElementById('multiDayScheduleShell');var hasRec=document.getElementById('hasRecurrence');var recType=document.getElementById('recurrenceType');if(hidden) hidden.value=type;if(shell) shell.classList.add('is-visible');if(rec) rec.style.display=type==='recurring'?'':'none';if(multi) multi.classList.toggle('is-visible', type==='multi-day');if(picker){Array.prototype.forEach.call(picker.querySelectorAll('[data-event-type]'), function(el){el.classList.toggle('is-active', el===btn);});}if(hasRec){hasRec.checked=type==='recurring';try{hasRec.dispatchEvent(new Event('change',{bubbles:true}));}catch(_){}}if(recType){try{recType.dispatchEvent(new Event('change',{bubbles:true}));}catch(_){}}})(this,'multi-day')">
                  ...
                  <button type="button" class="event-type-card ${inferredEventType === "recurring" ? "is-active" : ""}" data-event-type="recurring" onclick="(function(btn,type){var hidden=document.getElementById('eventTypeChoice');var shell=document.getElementById('eventTypeShell');var picker=document.getElementById('eventTypePicker');var rec=document.getElementById('recurrenceSettings');var multi=document.getElementById('multiDayScheduleShell');var hasRec=document.getElementById('hasRecurrence');var recType=document.getElementById('recurrenceType');if(hidden) hidden.value=type;if(shell) shell.classList.add('is-visible');if(rec) rec.style.display=type==='recurring'?'':'none';if(multi) multi.classList.toggle('is-visible', type==='multi-day');if(picker){Array.prototype.forEach.call(picker.querySelectorAll('[data-event-type]'), function(el){el.classList.toggle('is-active', el===btn);});}if(hasRec){hasRec.checked=type==='recurring';try{hasRec.dispatchEvent(new Event('change',{bubbles:true}));}catch(_){}}if(recType){try{recType.dispatchEvent(new Event('change',{bubbles:true}));}catch(_){}}})(this,'recurring')">
